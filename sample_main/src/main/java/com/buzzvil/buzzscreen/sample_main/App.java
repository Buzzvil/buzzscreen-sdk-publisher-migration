...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        // Original BuzzScreen initialization code
        // 기존 버즈스크린 초기화 코드.
        ...
        MigrationFrom.bind(new MigrationFrom.OnMigrationListener() {
            ...
            public Bundle onMigrationStarted() {
                ...
                // For this sample, automated log in is implemented byby assuming user_id as user authentication information.
            ...
            public void onMigrationCompleted() {
                // Sample code for if you want to save migration completion status
